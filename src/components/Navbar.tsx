...
function Navbar() {
  ...
  return (
    <>
      ...
      <div
        className={`top-0 h-screen bg-white flex flex-col pt-5 shadow-lg z-40 hover:bg-[#F5F5F7] transition-all duration-500 ease-in-out 
          ${isOpen ? 'w-[250px]' : 'w-[90px]'} // Larghezza dinamica`} 
      >
        <ul className="h-full w-full flex flex-col">

          {isOpen ? 
              <li className={`mb-2 justify-center flex flex-col whitespace-nowrap text-4xl
                  items-center `}>
                  <StepsTitle/>
              </li> : <li className={`justify-center flex flex-col whitespace-nowrap text-4xl
                  items-center`}>
                  <SH/>
              </li>
              }
